...
class OneHot():
    ...
    def version_9(cls, node, **kwargs):
        ...
        if node['dtype'] == np.int64:
            oht_node, out = make_node('OneHot', inputs=[x, 'depth', 'values'], outputs=[y], axis=axis)
            ...
            out_node, _ = make_node('Cast', inputs=[out], outputs=[y], to=NP_TYPE_TO_TENSOR_TYPE[node['dtype']])
